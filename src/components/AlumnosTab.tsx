...
export function AlumnosTab({ db, isDarkMode, currentColors }: { db: Firestore; isDarkMode: boolean; currentColors: any }) {
  const [alumnos, setAlumnos] = useState<Array<{
    Matricula: string;
    Nombre: string;
    Apellido: string;
    Carrera: string;
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <CardContent>
          <form onSubmit={manejarEnvio} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="matriculaAlumno" className={isDarkMode ? currentColors.titleText : currentColors.titleText}>Matrícula</Label>
              <Input
                id="matriculaAlumno"
            ...
            <div className="space-y-2">
              <Label htmlFor="nombreAlumno" className={isDarkMode ? currentColors.titleText : currentColors.titleText}>Nombre</Label>
              <Input
                id="nombreAlumno"
            ...
            <div className="space-y-2">
              <Label htmlFor="apellidoAlumno" className={isDarkMode ? currentColors.titleText : currentColors.titleText}>Apellido</Label>
              <Input
                id="apellidoAlumno"
            ...
            <div className="space-y-2">
              <Label htmlFor="carreraAlumno" className={isDarkMode ? currentColors.titleText : currentColors.titleText}>Carrera</Label>
              <Select
            ...
            <div className="space-y-2">
              <Label htmlFor="semestreAlumno" className={isDarkMode ? currentColors.titleText : currentColors.titleText}>Semestre</Label>
              <Select
            ...
            <div className="space-y-2">
              <Label htmlFor="turnoAlumno" className={isDarkMode ? currentColors.titleText : currentColors.titleText}>Turno</Label>
              <Select
            ...
            <div className="space-y-2">
              <Label htmlFor="grupoAlumno" className={isDarkMode ? currentColors.titleText : currentColors.titleText}>Grupo</Label>
              <Input
                id="grupoAlumno"
      ...
      <Card className={`${isDarkMode ? currentColors.cardBackground : currentColors.cardBackground} h-full overflow-auto`}>
        <CardHeader>
          <CardTitle className={isDarkMode ? currentColors.titleText : currentColors.titleText}>Lista de Alumnos</CardTitle>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className={isDarkMode ? currentColors.titleText : currentColors.titleText}>Carrera</TableHead>
                <TableHead className={isDarkMode ? currentColors.titleText : currentColors.titleText}>Semestre</TableHead>
                <TableHead className={isDarkMode ? currentColors.titleText : currentColors.titleText}>Turno</TableHead>
                <TableHead className={isDarkMode ? currentColors.titleText : currentColors.titleText}>Grupo</TableHead>
            ...
            <TableBody>
              {alumnos.map((alumno) => (
                <TableRow key={alumno.Matricula}>
                  <TableCell className={isDarkMode ? currentColors.descriptionText : currentColors.descriptionText}>{alumno.Matricula}</TableCell>
                  <TableCell className={isDarkMode ? currentColors.descriptionText : currentColors.descriptionText}>{alumno.Nombre}</TableCell>
                  <TableCell className={isDarkMode ? currentColors.descriptionText : currentColors.descriptionText}>{alumno.Apellido}</TableCell>
                  <TableCell className={isDarkMode ? currentColors.descriptionText : currentColors.descriptionText}>{alumno.Carrera}</TableCell>
                  <TableCell className={isDarkMode ? currentColors.descriptionText : currentColors.descriptionText}>{alumno.Semestre}</TableCell>
                  <TableCell className={isDarkMode ? currentColors.descriptionText : currentColors.descriptionText}>{alumno.Turno}</TableCell>
                  <TableCell className={isDarkMode ? currentColors.descriptionText : currentColors.descriptionText}>{alumno.Grupo}</TableCell>
                  <TableCell>
                    <Button
